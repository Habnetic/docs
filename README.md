...
## 📚 Purpose
This repository serves as the written backbone of Habnetic — a structured archive of theory, methodology, and development notes that link architectural thinking with probabilistic modeling and open-source computation.
